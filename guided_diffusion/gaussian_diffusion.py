...
class GaussianDiffusion:
    ...
    def condition_mean(self, cond_fn, p_mean_var, x, t, model_kwargs=None):
        ...
        gradient = cond_fn(x, self._scale_timesteps(t), guid_y=model_kwargs["y"])
    ...
    def p_sample(
        ...
        if conf["repaint.inpa_inj_sched_prev"]:
            ...
            if pred_xstart is not None:
                gt_keep_mask = model_kwargs.get("masks").prod(dim=1, keepdim=True)
                gt = model_kwargs["gt"]
            ...
            for t_last, t_cur in time_pairs:
                ...
                if t_cur < t_last:  # reverse
                    with th.no_grad():
                        ...
                        if sample_dir is not None and conf["debug"]:
                            import os
                    ...
                    t_shift = conf.get("repaint.inpa_inj_time_shift", 1)
